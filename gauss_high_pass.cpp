...
/******************************************************************************
 * Function: Menu_Frequency_Gaussian_High_Pass
...
bool MainWindow::Menu_Frequency_Gaussian_High_Pass(Image &image)
{
    fftw_complex* in;
    fftw_complex* out;
    fftw_complex* out2;
    ...
    double spread = 10;
    if(!Dialog("Gaussian High Pass Filter").Add(spread, "spread").Show())
        return false;
